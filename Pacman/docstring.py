...
Dự án game này bao gồm 5 file .py
1. constants.py - lưu các thông số cấu hình trò chơi
2. mazes.py - lưu dữ liệu mê cung
3. renderer.py - vẽ các cấu trúc trò chơi
4. actors.py - điều khiển di chuyển pacman và ghosts
5. main.py - quản lý chung, gameloop, ...
"""
